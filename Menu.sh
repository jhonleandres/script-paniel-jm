...
function display_output(){
  ...
  dialog --backtitle "Sistema de Gerenciamento de Servidor JM" --title "${t}" --clear --msgbox "$(<$OUTPUT)" ${h} ${w}
}
...
do
  ...
  "Check PDVs" "Funcoes para PDVs" \
  "Servidor Retaguarda" "Servicos para Servidor BD" \
  "Servidor Sactus" "Servicos para Servidor Sactus" \
  "Sistema da Backup" "Servico de Backup Srv BD" 2>"${INPUT}"
